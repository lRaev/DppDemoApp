...
import { ShoppingBag, ArrowUp, Leaf, Truck, ChevronDown, ChevronUp, Copy, Tag, Sparkles, Info, Shield, Recycle, HandHelping, Droplet, Zap, ChevronLeft, ChevronRight, CheckCircle, XCircle, Factory, Calendar, Award, Building, ExternalLink, HelpCircle, Footprints, Star, Wrench } from 'lucide-react'
        ...
        >
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-0">
              <Image src="/images/TC-logo-bs.png" alt="DigiPP Logo" width={80} height={80} />
