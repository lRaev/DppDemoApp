...
const demoMarkers: MarkerData[] = [
  { position: [31.791702, -7.092620], popupContent: "Cotton Origin: Morocco", type: 'origin' },
  { position: [23.424076, 53.847818], popupContent: "Polyester Origin: United Arab Emirates", type: 'origin' },
  { position: [41.902784, 12.496366], popupContent: "Manufactured in Rome, Italy", type: 'manufacturer'}
];
...
const productSteps: Step[] = [
  {
    ...
    details: 'Our work jacket is made from a blend of cotton and polyester, featuring reinforced seams and multiple pockets for ultimate functionality and durability in demanding work environments.'
  },
  {
    icon: <Tag className="h-6 w-6 text-violet-500" />,
    title: 'Brand Details',
    description: 'Workwear brand focused on durability and comfort.',
    details: 'We have been crafting premium workwear since 1990. We are committed to providing high-quality, long-lasting work apparel that meets the needs of various industries.'
  },
  {
    icon: <Sparkles className="h-6 w-6 text-violet-500" />,
    title: 'Care Instructions',
    description: 'Proper care ensures long-lasting performance.',
    details: 'Machine wash cold with like colors. Do not bleach. Tumble dry low. Cool iron if needed. Do not dry clean. For tough stains, pre-treat before washing.'
  },
]
...
const impactSteps: Step[] = [
  {
    ...
    details: 'We use organic cotton and recycled polyester in our jackets. Our manufacturing process is designed to minimize water usage and reduce chemical waste.'
  },
  {
    icon: <Sparkles className="h-6 w-6 text-green-600" />,
    title: 'Recycling Program',
    description: 'End-of-life product management.',
    details: 'We offer a take-back program for our work jackets. Returned jackets are either refurbished for donation or recycled into new materials.'
  }
]
...
const handlingSteps: Step[] = [
  {
    ...
    details: 'We use minimal packaging made from recycled materials. Our shipping partners are chosen based on their commitment to reducing carbon emissions.'
  },
  {
    icon: <ShoppingBag className="h-6 w-6 text-blue-600" />,
    title: 'Usage Tips',
    description: 'Get the most out of your work jacket.',
    details: 'Break in your jacket for maximum comfort. Utilize all pockets for efficient tool organization. For extreme weather, consider layering underneath.',
...
const productDetails = {
  ...
  healthAndSafety: {
    ...
    safetyCertifications: ['EN ISO 13688:2013 (Protective clothing - General requirements)', 'EN 343 (Protection against rain)'],
  ...
  consumerInformation: {
    ...
    repairServices: 'Free repairs for the first year, discounted repairs thereafter'
  },
  sustainabilityAndCircularEconomy: {
    recyclability: '95%',
    recycledContent: '35%',
    repairabilityScore: '9/10',
    endOfLifeInstructions: 'Return to any of our stores for recycling, or use our mail-in recycling program.',
  },
  environmentalImpact: {
    carbonFootprint: '8.5kg CO2',
    waterUsage: '120 liters',
    energy: '45 kWh'
  },
  certifications: ['GOTS', 'GRS', 'OEKO-TEX Standard 100']
}
    ...
    <Card className="w-full max-w-md mx-auto shadow-lg rounded-lg overflow-hidden bg-white text-gray-900">
      <CardContent className="p-0">
        <div className="bg-gradient-to-r from-orange-600/90 to-blue-800/90 backdrop-blur-md text-white p-2 relative overflow-hidden">
          ...
          <h2 className="text-xl font-semibold text-center">Discover Your Work Jacket's Journey</h2>
        </div>

        <div className="p-4">
          <h2 className="text-3xl font-bold mb-2 text-gray-800">Explore your</h2>
          <h1 className="text-4xl font-bold mb-6 text-primary">Work Jacket's Story</h1>
          ...
          <div className="grid grid-cols-3 gap-1 w-full bg-gray-100 rounded-lg p-1">
            <Button
              variant="ghost"
              className={`w-full ${activeSection === 'product' ? 'bg-white shadow-sm' : 'hover:bg-gray-200'} h-12 rounded-md transition-all duration-200`}
            ...
            <Button
              variant="ghost"
              className={`w-full ${activeSection === 'impact' ? 'bg-white shadow-sm' : 'hover:bg-gray-200'} h-12 rounded-md transition-all duration-200`}
            ...
            <Button
              variant="ghost"
              className={`w-full ${activeSection === 'handling' ? 'bg-white shadow-sm' : 'hover:bg-gray-200'} h-12 rounded-md transition-all duration-200`}
                  ...
                  <Tabs defaultValue="composition" className="w-full">
                    ...
                    <TabsContent value="consumer">
                      <dl className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                        ...
                        <dd>
                          <a href={productDetails.consumerInformation.sizeGuide} className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">
                            Download PDF
                          </a>
                        </dd>
          ...
          <div className="mt-8 space-y-4">
            <div className="bg-gradient-to-r from-primary/5 to-primary/10 p-4 rounded-lg shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-primary">Workwear Discount</h3>
                  <p className="text-xs text-gray-600">20% off your next purchase</p>
                </div>
            ...
            <div className="bg-secondary/5 p-4 rounded-lg shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-gray-700">30% off when you buy 3+ work jackets</p>
                </div>
                <Button variant="secondary" size="sm" className="w-full mt-2">Shop Now</Button>
              </div>
            </div>
          </div>
